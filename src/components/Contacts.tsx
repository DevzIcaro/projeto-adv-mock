...
// Interface para receber as imagens processadas pelo Astro
...
const lawyers = [
    {
        ...
        defaultImage: "/src/assets/adv2.jpg", // Fallback caso a prop falhe
    ...
    },
    {
        ...
        defaultImage: "/src/assets/adv1.jpg", // Fallback caso a prop falhe
        whatsapp: "https://wa.me/5517",
        maps: "https://maps.app.goo.gl/EiGxT8JE4pgAsDJT9",
        email: "mailto:dnv.advocacia.@gmail.com",
        instagram: "https://www.instagram.com/dnv.advocacia"
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    {lawyers.map((lawyer, index) => {
                        // Lógica de índice idêntica à do AssociateCards
